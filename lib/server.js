...
let licenseKey = (0, get_1.default)(process.env, 'edge_LICENSE', (0, get_1.default)(process.env, 'LICENSE_KEY', ''));
if (!licenseKey) {
    try {
...
const edge_core_1 = require("@formio/edge-core");
...
class Server extends edge_core_1.Server {
    constructor(config = {}) {
        ...
        super({
            db: config.db || new exports.Modules.db({
                url: (0, get_1.default)(process.env, 'MONGO', "mongodb://localhost:27017/edge"),
