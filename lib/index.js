...
exports.Actions = exports.Auth = exports.Database = exports.Processor = exports.Prepper = exports.Server = exports.Modules = void 0;
...
Object.defineProperty(exports, "Processor", { enumerable: true, get: function () { return process_1.Processor; } });
...
if (!licenseKey) {
    try {
        licenseKey = fs_1.default.readFileSync(path_1.default.join((0, process_2.cwd)(), 'license.txt'), 'utf8');
    }
    catch (err) {
...
class Server extends appserver_core_1.Server {
    constructor(config = {}) {
        if (config.processors) {
            exports.Modules.processor.processors = config.processors;
        }
        if (config.preppers) {
        ...
        super({
            db: config.db || new exports.Modules.db({
                url: (0, get_1.default)(process.env, 'MONGO', "mongodb://localhost:27017/subserver"),
                config: (0, get_1.default)(process.env, 'MONGO_CONFIG', "{}")
            }),
            processor: exports.Modules.processor,
